<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="webPlanCycle.aspx.cs" Inherits="ShenDnengWeb.webPlanCycle" %>
      ...
      <div class="row">
          <nav class="col-sm-3 col-md-2 hidden-xs-down bg-faded sidebar">
              <ul class="nav nav-pills flex-column">
                ...
                <li class="nav-item">
                  <a class="nav-link active" href="webPlanCycle.aspx">神灯周期计划前三2</a>
                </li>
                <li class="nav-item">
          ...
          ，<asp:Label ID="lbFailCount" runat="server" Text=""></asp:Label>
          <br />
