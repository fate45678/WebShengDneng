<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="webPlanCycleTENCENTFFCbackthree.aspx.cs" Inherits="ShenDnengWeb.webPlanCycleTENCENTFFCbackthree" %>
      ...
      <div class="row">
          <nav class="col-sm-3 col-md-2 hidden-xs-down bg-faded sidebar">
              <ul class="nav nav-pills flex-column">
                <li class="nav-item">
                  <a class="nav-link" href="webPlanCycleTENCENTFFC.aspx">神灯周期计划前三<span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                  <a class="nav-link active" href="webPlanCycleTENCENTFFCbackthree.aspx">神灯周期计划后三</a>
                </li>
                <li class="nav-item">
