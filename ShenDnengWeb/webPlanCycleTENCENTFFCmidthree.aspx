<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="webPlanCycleTENCENTFFCmidthree.aspx.cs" Inherits="ShenDnengWeb.webPlanCycleTENCENTFFCmidthree" %>
      ...
      <div class="row">
          <nav class="col-sm-3 col-md-2 hidden-xs-down bg-faded sidebar">
              <ul class="nav nav-pills flex-column">
                ...
                <li class="nav-item">
                  <a class="nav-link active" href="webPlanCycleTENCENTFFCmidthree.aspx">神灯周期计划中三</a>
                </li>
                <li class="nav-item">
